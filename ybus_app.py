...
st.title("⚡ Power System Y-Bus Matrix Builder")
...
if input_method == "Edit Table Manually":
    st.info("💡 Tip: You can copy-paste from Excel directly into this table. Click '+' to add rows.")
    # Editable Data Table
...
if df_input is not None and not df_input.empty:
    if st.button("🚀 Construct Y-Bus Matrix", type="primary"):
        try:
            # Run Calculation
            ...
            tab1, tab2, tab3 = st.tabs(["📄 Formatted View", "🔢 Raw Complex Values", "📉 Sparsity Plot"])

            with tab1:
                st.write("Readable format (Real ± Imag):")
